...
from dataset.image_text_loader import get_imagenet, get_wds_image_text_dataset
from dataset.transform import image_transform
from distributed import gather
from eval.datacomp.retr_eval import RetrievalDataset, image_captions_collage_fn_prefix
from eval.imagenet import evaluate_imagenet
from models.dual_encoder import DualEncoder, DualEncoderConfig
